...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HousingHistory.housing_date_discovered'
        db.add_column('countyapi_housinghistory', 'housing_date_discovered',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HousingHistory.housing_date_discovered'
        db.delete_column('countyapi_housinghistory', 'housing_date_discovered')
