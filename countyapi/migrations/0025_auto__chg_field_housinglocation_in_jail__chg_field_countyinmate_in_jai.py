...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HousingLocation.in_jail'
        db.alter_column(u'countyapi_housinglocation', 'in_jail', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CountyInmate.in_jail'
        db.alter_column(u'countyapi_countyinmate', 'in_jail', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'HousingLocation.in_jail'
        db.alter_column(u'countyapi_housinglocation', 'in_jail', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CountyInmate.in_jail'
        db.alter_column(u'countyapi_countyinmate', 'in_jail', self.gf('django.db.models.fields.NullBooleanField')(null=True))
