...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyPopulationCounts.booking_date'
        db.add_column('countyapi_dailypopulationcounts', 'booking_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DailyPopulationCounts.booking_date'
        db.delete_column('countyapi_dailypopulationcounts', 'booking_date')
