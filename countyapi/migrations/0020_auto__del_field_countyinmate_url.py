...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CountyInmate.url'
        db.delete_column(u'countyapi_countyinmate', 'url')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CountyInmate.url'
        raise RuntimeError("Cannot reverse this migration. 'CountyInmate.url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CountyInmate.url'
        db.add_column(u'countyapi_countyinmate', 'url',
