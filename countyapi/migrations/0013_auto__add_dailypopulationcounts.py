...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyPopulationCounts'
        db.create_table('countyapi_dailypopulationcounts', (
        ...
        db.send_create_signal('countyapi', ['DailyPopulationCounts'])

    def backwards(self, orm):
        # Deleting model 'DailyPopulationCounts'
        db.delete_table('countyapi_dailypopulationcounts')
    ...
    models = {
        ...
        'countyapi.dailypopulationcounts': {
            'Meta': {'object_name': 'DailyPopulationCounts'},
