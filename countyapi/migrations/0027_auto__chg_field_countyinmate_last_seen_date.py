...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """
        turn off auto updating of last_seen_date field so can make data migration without affecting existing values
        will turn it back on when migration is complete
        @param orm:
        @return:
        """
