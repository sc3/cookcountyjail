...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountyInmate.in_jail'
        db.add_column(u'countyapi_countyinmate', 'in_jail',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CountyInmate.in_jail'
        db.delete_column(u'countyapi_countyinmate', 'in_jail')
