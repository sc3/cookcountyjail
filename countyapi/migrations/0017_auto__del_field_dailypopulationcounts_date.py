...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DailyPopulationCounts.date'
        db.delete_column('countyapi_dailypopulationcounts', 'date')

    def backwards(self, orm):
        # Adding field 'DailyPopulationCounts.date'
        db.add_column('countyapi_dailypopulationcounts', 'date',
