...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InmateSummaries'
        db.create_table('countyapi_inmatesummaries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('current_inmate_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('countyapi', ['InmateSummaries'])

    def backwards(self, orm):
        # Deleting model 'InmateSummaries'
        db.delete_table('countyapi_inmatesummaries')
