...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HousingHistory.housing_date'
        db.delete_column('countyapi_housinghistory', 'housing_date')

    def backwards(self, orm):
        # Adding field 'HousingHistory.housing_date'
        db.add_column('countyapi_housinghistory', 'housing_date',
