...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CountyInmate.booking_date'
        raise RuntimeError("Cannot reverse this migration. 'CountyInmate.booking_date' and its values cannot be restored.")
