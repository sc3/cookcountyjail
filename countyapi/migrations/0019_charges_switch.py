...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for record in orm.ChargesHistory.objects.filter(id__gt=39451):
            temp = record.charges
            record.charges = record.charges_citation
            record.charges_citation = temp
            record.save()


    def backwards(self, orm):
        "Write your backwards methods here."
        print('This should not be implemented')
        pass
