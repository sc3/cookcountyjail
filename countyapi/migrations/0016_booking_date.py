...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Copy date field to booking_date field."
        for daily_population_count in orm.DailyPopulationCounts.objects.all():
            daily_population_count.booking_date = daily_population_count.date
            daily_population_count.save()

    def backwards(self, orm):
        "Copy booking_date field to date field."
        for daily_population_count in orm.DailyPopulationCounts.objects.all():
            daily_population_count.date = daily_population_count.booking_date
            daily_population_count.save()
